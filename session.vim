...
badd +0 HeatWave.h
badd +0 TestMouseable.h
badd +0 Selectable.h
badd +0 Selectable.cpp
badd +0 Selectable.txt
badd +0 SelectionController.h
badd +0 SelectionController.cpp
args SimWire.cpp
edit SimNode.cpp
...
exe 'vert 3resize ' . ((&columns * 176 + 136) / 273)
exe '4resize ' . ((&lines * 32 + 33) / 67)
exe 'vert 4resize ' . ((&columns * 176 + 136) / 273)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 456 - ((0 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
456
...
exe '3resize ' . ((&lines * 26 + 33) / 67)
exe 'vert 3resize ' . ((&columns * 86 + 136) / 273)
exe '4resize ' . ((&lines * 37 + 33) / 67)
exe 'vert 4resize ' . ((&columns * 86 + 136) / 273)
exe '5resize ' . ((&lines * 21 + 33) / 67)
exe 'vert 5resize ' . ((&columns * 87 + 136) / 273)
exe '6resize ' . ((&lines * 42 + 33) / 67)
exe 'vert 6resize ' . ((&columns * 87 + 136) / 273)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((20 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 16 - ((11 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
exe 'vert 2resize ' . ((&columns * 89 + 136) / 273)
exe 'vert 3resize ' . ((&columns * 81 + 136) / 273)
exe '4resize ' . ((&lines * 32 + 33) / 67)
exe 'vert 4resize ' . ((&columns * 101 + 136) / 273)
exe '5resize ' . ((&lines * 31 + 33) / 67)
exe 'vert 5resize ' . ((&columns * 101 + 136) / 273)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((37 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((31 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 88 + 136) / 273)
exe 'vert 2resize ' . ((&columns * 90 + 136) / 273)
exe 'vert 3resize ' . ((&columns * 93 + 136) / 273)
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((5 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
...
wincmd w
argglobal
edit ~\vimfiles\after\ftplugin\txt.vim
vnoremap <buffer> <silent> [" :exe "normal! gv"|call search('\%(^\s*".*\n\)\%(^\s*"\)\@!', "bW")
nnoremap <buffer> <silent> [" :call search('\%(^\s*".*\n\)\%(^\s*"\)\@!', "bW")
vnoremap <buffer> <silent> [] m':exe "normal! gv"|call search('^\s*endf*\%[unction]\>', "bW")
nnoremap <buffer> <silent> [] m':call search('^\s*endf*\%[unction]\>', "bW")
...
wincmd w
argglobal
edit ~\vimfiles\after\ftplugin\asm.vim
vnoremap <buffer> <silent> [" :exe "normal! gv"|call search('\%(^\s*".*\n\)\%(^\s*"\)\@!', "bW")
nnoremap <buffer> <silent> [" :call search('\%(^\s*".*\n\)\%(^\s*"\)\@!', "bW")
vnoremap <buffer> <silent> [] m':exe "normal! gv"|call search('^\s*endf*\%[unction]\>', "bW")
nnoremap <buffer> <silent> [] m':call search('^\s*endf*\%[unction]\>', "bW")
